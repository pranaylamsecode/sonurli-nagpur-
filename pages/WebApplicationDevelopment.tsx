...
export const WebApplicationDevelopment: React.FC = () => {
  const features = [
    {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <Reveal delay={200}>
              <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
                VeerIT is having expertise in popular technologies including
                Core PHP, Codeigniter, Yii2, Laraval, Shopify Liquid, ASP.Net
                and HTML5. Our systems are fully responsive cross browser, cross
                device ready and customized to specific business needs.
              </p>
            </Reveal>
          </div>
        </section>
              ...
              <Reveal>
                <div>
                  ...
                  <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                    <p>
                      Whether it’s a new feature to be developed or stand-alone
                      web application or custom tailored solution required,
                      VeerIT team creates solutions that solve business
                      problems, ease business’s processes for the clients with
                      higher levels of satisfaction.
                    </p>
                    <p>
                      Every business has different business logic and require
                      web development application for their unique needs. VeerIT
                      has helped hundreds of companies realize their maximum
                      cost savings through custom solutions.
                    </p>
                  </div>
                </div>
              </Reveal>
