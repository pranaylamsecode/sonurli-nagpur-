...
export const MobileAppsDevelopment: React.FC = () => {
  const features = [
    {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <Reveal delay={200}>
              <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
                VeerIT is an established offshore software development company
                providing web application development services, IT consulting,
                and custom solutions to clients worldwide.
              </p>
            </Reveal>
          </div>
        </section>
              ...
              <Reveal>
                <div>
                  ...
                  <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                    <p>
                      Started in the year 2006, VeerIT provides full-cycle
                      services in the areas of software development, web-based
                      enterprise solutions, web application, and portal
                      development.
                    </p>
                    <p>
                      Combining our solid business domain experience, technical
                      expertise, profound knowledge of latest industry trends,
                      and quality-driven delivery model, we offer progressive
                      end-to-end web solutions.
                    </p>
                    <p>
                      At VeerIT, we are totally business-focused. We know how
                      important your web presence is to your organization. Our
                      mission is to eliminate risk by applying a broad-based
                      approach to site design that covers e-Business strategy,
                      user-centered design, usability, and project management.
                    </p>
                  </div>
                </div>
              </Reveal>
